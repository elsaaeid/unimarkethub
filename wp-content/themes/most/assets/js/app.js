...
function ms_theme_mode() {
    if ($.exists('.ms_theme_mode')) {
        ...
        // Check if a theme is saved in cookies, otherwise default to dark
        var currentTheme = getCookie('theme-mode') || 'dark';
        
        // Set initial theme based on cookie value or default to dark
